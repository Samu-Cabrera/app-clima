...
const botonMode = document.getElementById('button-mode');

//boton modo ligth
botonMode.addEventListener('click', () => {
  body.classList.toggle('click__mode');
})
...
const peticionAPI = (API) => {
    ...
    .then(data => {
      ...
      velocidadViento.innerHTML = `<i class="ri-windy-fill"></i> Wind: ${viento} m/s`; 
...
botonBuscar.addEventListener('click', () => {
    if(textInput.value != ""){
      ...
      mensajeError.innerHTML = 'Por favor ingrese ciudad o Pais';
